...
useEffect(() => {
  ...
  const fetchNotificationStatus = async () => {
    try {
      const response = await axios.get(`${baseURL}/api/users/checkHeadingNotification`, {
  ...
  const updateNotificationStatus = async (roomId,senderId) => {
    ...
    try {
      ...
      await axios.post(`${baseURL}/api/users/updateNotificationStatus/${roomId}`, {
  ...
  const handleCommentIconClick = async () => {
    try {
      ...
      await axios.post(`${baseURL}/api/users/removeNotifications/${userInfo._id}`);
...
{userInfo.profileImage ? (
    <Image src={`${baseURL}/api/users/uploads/${userInfo.profileImage}`} alt="Display Picture" className="dp-image rounded-circle" />
