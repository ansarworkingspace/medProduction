...
useEffect(() => {
  ...
  useEffect(() => {
    async function fetchChatRooms() {
      try {
        const response = await axios.get(`${baseURL}/api/users/chatRooms`, {
...
useEffect(() => {
  ...
  const fetchNotificationStatus = async () => {
    try {
      const response = await axios.get(`${baseURL}/api/users/notificationStatus`, {
        withCredentials: true,
      });
  ...
  const handleOpenChat = async (chatRoomId,chatRoom) => {
    ...
    try {
      await axios.delete(`${baseURL}/api/users/deleteMessageId/${chatRoomId}`, {
        withCredentials: true,
      });
    ...
    <div className='followingBox' key={chatRoom._id}>
      <div className='imageONbox'>
        {chatRoom.otherParticipant.profileImage ? (
          <Image
            src={`${baseURL}/api/users/uploads/${chatRoom.otherParticipant.profileImage}`}
            alt="Profile"
